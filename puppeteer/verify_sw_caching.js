...
//  const { URL } = require('../src/variables');
const { STAGE_URL : URL } = require('../src/variables');
 ...
 console.log(chalk.cyan(`Requests made by ${URL}`), `(${chalk.green('✔ cached by sw')}, ${chalk.red('✕ not cached')})`);
